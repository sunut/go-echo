...
type User struct {
	...
	Ucode   null.String `boil:"ucode" json:"ucode,omitempty" toml:"ucode" yaml:"ucode,omitempty"`
...
var UserWhere = struct {
	...
	Ucode:   whereHelpernull_String{field: "`user`.`ucode`"},
	Mail:    whereHelpernull_String{field: "`user`.`mail`"},
}
...
var (
	userAllColumns            = []string{"id", "name", "address", "ucode", "mail"}
	userColumnsWithoutDefault = []string{"id", "name", "address", "ucode", "mail"}
